							...
							<div class="col-sm-3 col-xs-12">
								<div class="form-group drop-custum">
									...
									<select class="form-control show-tick" name="selectModel">
                                        <?php                                        
                                            echo "<option value=1 selected>Model 1</option>";
                                            echo "<option value=2>Model 2</option>";														
										?>                                        
									</select>
								</div>
							</div>          
								...
								<div class="form-group drop-custum">
									...
									<select class="form-control show-tick" name="selectStatus">
                                        <?php                                        
                                            ...
                                            echo "<option value=2>Checked Out</option>";
											echo "<option value=3>Not Available</option>";	
